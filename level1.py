...
def leve1loop():
    ...
    l1boss = enemy.Bosslvl1("Mobs/lvl1boss_left.png", [543, 350], [100, 134], 750, 10, "lvl1boss", 0.5,.8,"Mobs/lvl1boss_right.png","Mobs/lvl1boss_left.png","Items/1bossaxe_right.png","Items/1bossaxe_left.png")
